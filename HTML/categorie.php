...
<body>
  ...
  <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/img/images_the_district/bg1.jpeg" class="d-block w-100" alt="1">
      </div>
      <div class="carousel-item">
        <img src="/img/images_the_district/bg2.jpeg" class="d-block w-100" alt="2">
      </div>
      <div class="carousel-item">
  ...
  <div class="card-group">
    <div class="card" style="width: 20rem;">
      <img src="/img/images_the_district/catégorie/aperitif.png" class="card-img-top" alt="nos-apéritifs">
      <div class="card-body">
    ...
    <div class="card" style="width: 20rem;">
      <img src="/img/images_the_district/catégorie/salade.png" class="card-img-top" alt="nos-salades">
      <div class="card-body">
    ...
    <div class="card" style="width: 20rem;">
      <img src="/img/images_the_district/catégorie/hamburger.png" class="card-img-top" alt="nos-burgers">
      <div class="card-body">
    ...
    <div class="card" style="width: 20rem;">
      <img src="/img/images_the_district/catégorie/pizza.png" class="card-img-top" alt="nos-pizzas">
      <div class="card-body">
    ...
    <div class="card" style="width: 20rem;">
      <img src="/img/images_the_district/catégorie/desserts.png" class="card-img-top" alt="nos-desserts">
      <div class="card-body">
    ...
    <div class="card" style="width: 20rem;">
      <img src="/img/images_the_district/catégorie/café/café.png" class="card-img-top" alt="nos-cafés">
      <div class="card-body">
